package demo.com.tutorialsninja.utilities;
...
public class Utility extends ManageBrowser {
    ...
    // this method will send text on element
    public void sendTextToElementWithClearText(WebElement element, String inputText) {
        element.clear();
...
//*************************** Select Class Methods ***************************************//
    ...
    public void selectByContainsTextFromListOfElements(List<WebElement> elements, String text) {
...
//***************************** Is Display Methods **********************************************//
    ...
    public void selectDateFromDatePicker(String year, String month, String date,
                                         WebElement dateButtonXpath , WebElement monthAndYearXpath,
                                         WebElement nextButtonPath, List<WebElement> allDatesXpath){
       ...
       /* String year = "2024";
        ...
        while (true) {
            String monthAndYear = monthAndYearXpath.getText();
        ...
        List<WebElement> allDates = allDatesXpath;
